...
const Func = {
  pair: async (conn, code, num, m, reply_status) => {
    await conn.sendButton(m.chat, {
      imageUrl: "https://litter.catbox.moe/c6ikee.jpg",
...
> *_افتح واتساب > الأجهزة المرتبطة > ربط جهاز برقم الهاتف > أدخل الكود_*`,
      footerText: "@𝑺𝒚𝒔𝒕𝒆𝒎_𝑺𝒖𝒃𝑩𝒐𝒕𝒔_Aisa-v1",
      buttons: [
        { name: "cta_copy", params: { display_text: "⟨| 𝐂𝐨𝐩𝐲 𝐂𝐨𝐝𝐞 |⟩", copy_code: code } },
        { name: "cta_url", params: { display_text: "⟨🫒| 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 Aisa-v1 |🫒⟩", url: "https://google.com" } },
      ],
      mentions: [m.sender],
      newsletter: {
        name: 'Aisa-v1',
